...
export const renderPage = function() {
  ...
  <div id="navbarBasicExample" class="navbar-menu">
    <div class="navbar-start">
      ...
      <a id = "playerButton" class="navbar-item" onclick="window.location.href = 'playerPage.html'">
        Players
      </a>

      <a id = "teamsButton" class="navbar-item">
        Teams
      </a>

      <a id = "myTeamButton" class="navbar-item">
        My Team
      </a>
      <a id = "searchButton" class="navbar-item">
        Search
      </a>
    ...
    <div class="navbar-end">
      <div class="navbar-item">
        <div class="buttons">
          <a class="button is-info" onclick = "window.location.href = 'signup.html'">
            <strong>Sign up</strong>
          </a>
          <a class="button is-light" onclick = "window.location.href = 'loginpage.html'">
            Log in
          </a>
        </div>
      </div>
